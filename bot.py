...
pr0fess0r_99=Client(
    ...
    bot_token = os.environ["BOT_TOKEN" "6583287452:AAFmZlFTX0tFE7VhQ34zHigf_eIS3Tvw4D0"],
    api_id = int(os.environ["API_ID" "24556417"]),
    api_hash = os.environ["API_HASH" "24008c23b7506a0bd8821f19c19cd654"]
)
...
async def start(client: pr0fess0r_99, message: Message):
    ...
    button=[[
      InlineKeyboardButton("𝚄𝙿𝙳𝙰𝚃𝙴𝚉", url="https://t.me/Anime_Sub_Dub"),
      InlineKeyboardButton("𝚂𝚄𝙿𝙿𝙾𝚁𝚃", url="https://t.me/Anime_Sub_Dub")
      ],[
      InlineKeyboardButton("𝚂𝚄𝙱𝚂𝙲𝚁𝙸𝙱𝙴", url=f"https://telegram.me/Anime_Sub_Dub")
      ]]
